"""AgenticStrategy truncation metadata (B2-1)."""
...
def test_agentic_stamps_metadata_when_truncated(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_agentic_no_truncation_metadata_when_short(monkeypatch: pytest.MonkeyPatch) -> None:
